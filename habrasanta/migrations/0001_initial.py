    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "login",
                    models.CharField(
                        db_column="username", editable=False, max_length=25, unique=True
                    ),
                ),
                ...
                (
                    "email_allowed",
                    models.BooleanField(
                        default=True, editable=False, verbose_name="e-mail уведомления"
                    ),
                ),
                (
                    "email_token",
                ...
                (
                    "is_banned",
                    models.BooleanField(
                        default=False, editable=False, verbose_name="забанен"
                    ),
                ),
                (
                    "first_login",
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        editable=False,
                        null=True,
                        verbose_name="последнее уведомление о новых сообщениях",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fullname",
                    models.CharField(max_length=80, verbose_name="полное имя"),
                ),
                ...
                (
                    ...
                    django_countries.fields.CountryField(
                        max_length=2, null=True, verbose_name="страна"
                    ),
                ),
                (
                    "gift_shipped_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (10, "Разблокировка пользователя"),
                            (11, "Заметка обновлена"),
                            (12, "Отмена отправки"),
                            (13, "Новый сезон"),
                            (14, "Отписка от EMail"),
                ...
                (
                    "ip_address",
                    models.GenericIPAddressField(null=True, verbose_name="IP-адрес"),
                ),
                (
                    "obo",
                    models.ForeignKey(
